<template>
  <div class="relative mb-4">
    ...
    <div v-if="showSearch" class="absolute w-full max-h-[660px] overflow-auto bg-zinc-700">
      ...
      <div v-for="boss in searchedBosses" :key="boss.name" @click="enterGuess(boss)" @keydown.enter="enterGuess(boss)" tabindex="0" class="cursor-pointer border-t-2 shadow-2xl outline-none duration-200 hover:bg-zinc-900 focus:bg-zinc-900">
